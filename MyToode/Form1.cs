...
namespace MyToode
{
    public partial class Form1 : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            // Проверяем, существует ли файл уже, если нет - копируем
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@kogus", int.Parse(txtQuantity.Text));
                cmd.Parameters.AddWithValue("@hind", decimal.Parse(txtPrice.Text));
                cmd.Parameters.AddWithValue("@pilt", newImagePath); // Сохраняем путь к новому файлу
